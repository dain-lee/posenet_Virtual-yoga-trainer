...
$.getJSON('yoga.json', function (param) {
    ...
    console.log(param[0].xs);
    kneeL = param[0].xs[13];
    kneeR = param[0].xs[14];
    hipL = param[0].xs[11];
    hipR = param[0].xs[12];
    ankleL = param[0].xs[15];
    ankleR = param[0].xs[16];
    shoulderL = param[0].xs[5];
    shoulderR = param[0].xs[6];
    elbowL = param[0].xs[7];
    elbowR = param[0].xs[8];
    wristL = param[0].xs[9];
    wristR = param[0].xs[10];
